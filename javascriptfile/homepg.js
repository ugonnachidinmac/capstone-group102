...
// // Function to toggle the market place popup
// function martoggle() {
//   var marblur = document.getElementById("marblur");
//   marblur.classList.toggle("active");
//   var marpopup = document.getElementById("marpopup");
...
function login(event) {
  ...
  loginButton.parentNode.appendChild(loadingSpinner);
...
function marcloseButton() {
  const marbutton = document.getElementById("marcloseButton");
  marbutton.parentNode.style.display = "none";
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  links.forEach(function (link) {
    ...
    // Normalize trailing slashes to avoid mismatches
    ...
    if (linkPathname === currentPageUrl) {
      link.classList.add("active");
    }
  });
});
